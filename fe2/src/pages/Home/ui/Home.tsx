  ...
  return (
    <div className={cls['snackbar-but-cooler']}>
      <div className={cls.text}>
        <svg className={cls.ello} xmlns="http://www.w3.org/2000/svg" width="47" height="49" viewBox="0 0 47 49" fill="none">
          <g clip-path="url(#clip0_43_2681)">
            <path d="M23.25 1.1924C10.4091 1.1924 0 11.6015 0 24.4424C0 37.2833 10.4091 47.6924 23.25 47.6924C36.0909 47.6924 46.5 37.2833 46.5 24.4424C46.5 11.6015 36.0909 1.1924 23.25 1.1924ZM36.735 27.9299C35.1853 34.0527 29.6053 38.3924 23.25 38.3924C16.8947 38.3924 11.3147 34.0527 9.765 27.9299C9.61031 27.2324 9.9975 26.4571 10.695 26.3024C11.3925 26.1477 12.1678 26.5349 12.3225 27.2324C13.6397 32.1927 18.135 35.6802 23.25 35.6802C28.365 35.6802 32.8603 32.1927 34.1775 27.2324C34.3322 26.5349 35.1075 26.0699 35.805 26.3024C36.5025 26.4571 36.9675 27.2324 36.735 27.9299Z" fill="#054DD1" />
          </g>
          <defs>
            <clipPath id="clip0_43_2681">
              <rect width="46.5" height="48" fill="white" transform="translate(0 0.442398)" />
            </clipPath>
          </defs>
        </svg>
        <div className={cls.frame}>
          ...
          <p className={cls.subhead}>
            Add collections and resources to your microsite from nationwide digital libraries sharing on the OER
            Exchange.
          </p>
        </div>
      </div>
      <div className={cls['button-wrapper']}>
        <div className={cls.button} onClick={() => navigate('/imls/site-collections/main')}>
  ...
  <div className={cls.news}>
    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="24" viewBox="0 0 28 24" fill="none">
      <g clip-path="url(#clip0_43_2693)">
        <path d="M12.2 22.1016C12.7063 22.2797 13.25 21.9094 13.25 21.375V3.68437C13.25 3.4875 13.175 3.29062 13.0156 3.16875C12.0969 2.4375 9.9875 1.5 7.25 1.5C4.88281 1.5 2.67031 2.12344 1.34844 2.62969C0.81875 2.83594 0.5 3.36094 0.5 3.92813V21.2859C0.5 21.8438 1.1 22.2328 1.62969 22.0594C3.10625 21.5672 5.44531 21 7.25 21C8.83906 21 10.9531 21.6562 12.2 22.1016ZM15.8 22.1016C17.0469 21.6562 19.1609 21 20.75 21C22.5547 21 24.8938 21.5672 26.3703 22.0594C26.9 22.2375 27.5 21.8438 27.5 21.2859V3.92813C27.5 3.36094 27.1813 2.83594 26.6516 2.63438C25.3297 2.12344 23.1172 1.5 20.75 1.5C18.0125 1.5 15.9031 2.4375 14.9844 3.16875C14.8297 3.29062 14.75 3.4875 14.75 3.68437V21.375C14.75 21.9094 15.2984 22.2797 15.8 22.1016Z" fill="#FCFCFC" />
      </g>
      <defs>
    ...
    <div className={classNames(cls.Home, {}, [className])}>
                ...
                <div className={cls['collection-owner']}>
                  ...
                  <div className={cls.values} style={{ height: '172px' }}>
                    {tenants.filter((item) => item.name && item.name.toLowerCase().includes(tenantFilter)).map((item, i) => (
                      <div className={cls['div-2']} id="subjects" key={item.id}>
                  ...
                  <div className={cls['values-wrapper']}>
                    <div className={cls.values} style={{ height: '172px' }}>
                      {levels.filter((item) => item.name && item.name.toLowerCase().includes(levelFilter)).map((item, i) => (
                        <div className={cls['div-2']} id="levels" key={item.id}>
      ...
      <div className={cls.links_wrapper}>
        ...
        <div className={cls.search_redirect}>
          ...
          <Button onClick={() => navigate(`/imls/search/${window.location.search.toString()}`)} title="Search" className={cls.search_button} />
        </div>
      ...
      {data && (
        <div className={cls.cards}>
          {data.map((item) => <CollectionItemCard collection={item} className={cls.cardWidth} />)}
        </div>
      )}
      <div className={cls.grid}>
        ...
        <div>
          ...
          <div className={cls.content} style={{ background: '#A08BFF' }}>
            <h5>Stay Updated</h5>
            <p>
              Get notified of the newest changes in OER when you subscribe to collections.
            </p>
            <div className={cls.act}>
              <span>See what’s new in </span>
            </div>
            <div className={cls.action} onClick={() => navigate('/imls/site-collections/subscribed-updates')}>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                <path d="M2.23125 15.0507L10.7016 22.9586C11.0531 23.2867 11.5172 23.4695 12 23.4695C12.4828 23.4695 12.9469 23.2867 13.2984 22.9586L21.7687 15.0507C23.1938 13.7242 24 11.8632 24 9.91793V9.64605C24 6.36949 21.6328 3.57574 18.4031 3.03668C16.2656 2.68043 14.0906 3.37886 12.5625 4.90699L12 5.46949L11.4375 4.90699C9.90938 3.37886 7.73438 2.68043 5.59688 3.03668C2.36719 3.57574 0 6.36949 0 9.64605V9.91793C0 11.8632 0.80625 13.7242 2.23125 15.0507Z" fill="#1E1E1E" />
              </svg>
              <span>Subscribed OER</span>
            </div>
            <div className={cls.action} onClick={() => navigate('/imls/site-collections/shared-updates')}>
              <svg xmlns="http://www.w3.org/2000/svg" width="22" height="25" viewBox="0 0 22 25" fill="none">
        ...
        <div>
          ...
          <div className={cls.content} style={{ background: '#7EF6C6' }}>
            ...
            <p>
              Get recommended content delivered when you set your content preferences.
            </p>
            <div className={cls.act}>
            ...
            <div className={cls.action} onClick={() => navigate('/imls/site-collections/subscribed-preferences')}>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                <path d="M2.23125 15.0507L10.7016 22.9586C11.0531 23.2867 11.5172 23.4695 12 23.4695C12.4828 23.4695 12.9469 23.2867 13.2984 22.9586L21.7687 15.0507C23.1938 13.7242 24 11.8632 24 9.91793V9.64605C24 6.36949 21.6328 3.57574 18.4031 3.03668C16.2656 2.68043 14.0906 3.37886 12.5625 4.90699L12 5.46949L11.4375 4.90699C9.90938 3.37886 7.73438 2.68043 5.59688 3.03668C2.36719 3.57574 0 6.36949 0 9.64605V9.91793C0 11.8632 0.80625 13.7242 2.23125 15.0507Z" fill="#1E1E1E" />
              </svg>
              <span>Subscribed OER</span>
            </div>
            <div className={cls.action} onClick={() => navigate('/imls/site-collections/shared-preferences')}>
              <svg xmlns="http://www.w3.org/2000/svg" width="22" height="25" viewBox="0 0 22 25" fill="none">
