...
export const fetchCases = (term = '', page = 1, sort, topics = [], grades = [], frameworks = []) => async (dispatch: AppDispatch) => {
  const params = {}
  ...
  if (frameworks && frameworks.length) params['f.atlas_alignment_standard'] = frameworks
  try {
