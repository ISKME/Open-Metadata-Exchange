...
const Fab = () => <button className={cls.fab}><Pen /></button>;
...
export function Asset() {
  ...
  return (
    <div className={cls.Asset}>
      ...
      <a href="#" onClick={() => navigate(-1)}>⬅ Back to collection</a>
      <section className={`${cls.description} ${cls.split}`}>
        ...
        <div className={cls.desc}>
          ...
          <div>
            <button onClick={() => { window.location.href = url; }}>View Resource</button>
            {' '}
      ...
      <section>
        <div className={cls.f}>
          <div>
            <img src={historyImage} alt="history" width="24" />
            3 Updates/Edits since first published {create}
          </div>
          {(history && history.length) ? (<div>
            <img src={remix} alt="history" width="24" />
            {history.length} Remixes
          </div>) : ''}
          {(history && history.length) ? (<a
            href="#"
            onClick={() => {
          ...
          <div>
            <div>
              ...
              <p className={cls['para-space']}>
                ...
                {license && (<b>License: </b>)}
                {license}
                {licenseImage && <img src={licenseImage} alt="CC" style={{ marginLeft: '8px' }} />}
              </p>
            </div>
            <div>
              <b>Tags: </b>
            ...
            <div className={cls.BN}>
              {keywords.map((item) => <a href="#">{item}</a>)}
            </div>
          </div>
        </section>
        {/* <section> */}
