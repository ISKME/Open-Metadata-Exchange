...
export function ShareContent({ className }: ShareContentProps) {
  ...
  function save() {
    axios.post('/api/imls/v2/collections/site-collections/picker/', null, {
      params: {
        share: selects,
        unshare: deselects,
      },
      ...
      setTimeout(() => {
        window.location.href = '/imls/site-collections/shared-collections';
      }, 1000);
    });
  }
    ...
    <div className={classNames(cls.allcollections, {}, [className])}>
      ...
      <div className={cls.search_block}>
        ...
        <Link to="/imls/site-collections/shared-collections">
          <button className="btn btn-danger" onClick={cancel} style={{ borderRadius: '50%' }}>X</button>
        </Link>
      </div>
